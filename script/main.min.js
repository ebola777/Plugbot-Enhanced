...
define("app/models/3rd/PlugBot","jquery app/base/Context app/models/PlaybackModel app/views/room/PlaybackView app/models/RoomModel app/views/room/meta/AvatarRolloverView app/models/3rd/EmojiUI".split(" "),function(a,x,A,B,b,d,c){function f(){API.on(API.DJ_ADVANCE,h);API.on(API.WAIT_LIST_UPDATE,v);API.on(API.DJ_UPDATE,v);API.on(API.VOTE_UPDATE,function(a){l&&s()});API.on(API.USER_JOIN,function(a){l&&s()});API.on(API.USER_LEAVE,function(a){l&&s()});API.on(API.CHAT,c.onChatReceived,c);x.on("chat:send",
c.onChatReceived,c)}function g(){a("#plugbot-ui").remove();a("#chat").prepend('<div id="plugbot-ui" class="unselectable"></div>');var b=n?"#3FFF00":"#ED1C24",d=p?"#3FFF00":"#ED1C24",c=q?"#3FFF00":"#ED1C24",f=k?"#3FFF00":"#ED1C24",e=l?"#3FFF00":"#ED1C24";a("#plugbot-ui").append('<p id="plugbot-btn-woot" style="color:'+b+'">auto-woot</p><p id="plugbot-btn-meh" style="color:'+d+'">auto-meh</p><p id="plugbot-btn-queue" style="color:'+c+'">auto-queue</p><p id="plugbot-btn-hidevideo" style="color:'+f+'">hide video</p><p id="plugbot-btn-skipvideo" style="color:#ED1C24">skip video</p><p id="plugbot-btn-userlist" style="color:'+
e+'">userlist</p><p><a href="'+C+'" target="_blank" id="plugbot-btn-openvid" style="color:#FFF">open video link</a></p>')}function e(){a(window).resize(function(){c.repos()});a("body").keydown(a.proxy(c.onBodyKeydown,c)).keyup(a.proxy(c.onBodyKeyup,c));a("#chat-input-field").keydown(a.proxy(c.onChatInputKeydown,c));a("#button-chat-expand").click(function(){setTimeout(function(){c.repos()},100)});a("#button-chat-collapse").click(function(){setTimeout(function(){c.repos()},100)});a("#plugbot-btn-userlist").live("click",
function(){l=!l;a(this).css("color",l?"#3FFF00":"#ED1C24");a("#plugbot-userlist").css("visibility",l?"visible":"hidden");l?s():a("#plugbot-userlist").empty();jaaulde.utils.cookies.set(I,l)});a("#plugbot-btn-woot").live("click",function(){(n=!n)&&(p=!1);a(this).css("color",n?"#3FFF00":"#ED1C24");a("#plugbot-btn-meh").css("color",p?"#3FFF00":"#ED1C24");n&&a("#button-vote-positive").click();jaaulde.utils.cookies.set(J,n)});a("#plugbot-btn-meh").live("click",function(){(p=!p)&&(n=!1);a(this).css("color",
p?"#3FFF00":"#ED1C24");a("#plugbot-btn-woot").css("color",n?"#3FFF00":"#ED1C24");p&&a("#button-vote-negative").click()});a("#plugbot-btn-hidevideo").live("click",function(){k=!k;a(this).css("color",k?"#3FFF00":"#ED1C24");a(this).text(k?"hiding video":"hide video");a("#yt-frame").animate({height:k?"0px":"271px"},{duration:"fast"});a("#playback .frame-background").animate({opacity:k?"0":"0.91"},{duration:"medium"});jaaulde.utils.cookies.set(K,k)});a("#plugbot-btn-skipvideo").live("click",function(){m=
!m;a(this).css("color",m?"#3FFF00":"#ED1C24");a(this).text(m?"skipping video":"skip video");var b=API.getVolume();m?(D=b,API.setVolume(0)):API.setVolume(D);m?(w||k||a("#plugbot-btn-hidevideo").click(),w=!0):(w&&k&&a("#plugbot-btn-hidevideo").click(),w=!1)});a("#plugbot-btn-queue").live("click",function(){q=!q;a(this).css("color",q?"#3FFF00":"#ED1C24");q&&!t()&&u();jaaulde.utils.cookies.set(L,q)});a(".plugbot-userlist-user").live("click",function(){var c=a(this).position(),Q=a(this).text(),f=null;
a.each(b.get("users"),function(a,b){if(b.get("username")===Q)return f=b,!1});d.showChat(f,{x:c.left+300,y:c.top})});R()}function h(b){k&&!m&&(a("#yt-frame").css("height","0px"),a("#playback .frame-background").css("opacity",".0"));m&&(a("#plugbot-btn-skipvideo").css("color","#ED1C24").text("skip video"),w&&k&&a("#plugbot-btn-hidevideo").click(),API.setVolume(D),B.onRefreshClick(),w=m=!1);n?a("#button-vote-positive").click():p&&a("#button-vote-negative").click();l&&s();M(!1)}function v(){q&&!t()&&
u()}function t(){var a=API.getUser();return-1!==API.getWaitList().indexOf(a)||-1!==API.getDJs().indexOf(a)}function u(){"block"===a("#button-dj-play").css("display")?a("#button-dj-play").click():API.getWaitList().length<S&&API.djJoin()}function s(){if(E){var b=new Date,c=b.getTime(),b=null;clearTimeout(N);if(c-F>=O){F=c;b=a("#plugbot-userlist");c=API.getUsers();b.html(" ").append('<h1 style="text-indent:12px;color:#42A5DC;font-size:14px;font-variant:small-caps;">Users: '+c.length+"</h1>").append('<p style="padding-left:12px;text-indent:0px !important;font-style:italic;color:#42A5DC;font-size:11px;">Click a username to<br />open user-box!</p><br />');
...
break;case 1:e="featured";break;case 2:e="bouncer";break;case 3:e="manager";break;case 4:case 5:e="host";break;case 9:case 10:e="admin"}f?"normal"===e?z("void","#42A5DC",c):z(e+"_current.png","#42A5DC",c):"normal"===e?z("void",G(b.vote),c):z(e+T(b.vote),G(b.vote),c)})}else N=setTimeout(function(){s()},O)}}function G(a){if(!a)return"#fff";switch(a){case -1:return"#c8303d";case 0:return"#fff";case 1:return"#c2e320"}}function T(a){if(!a)return"_undecided.png";switch(a){case -1:return"_meh.png";case 0:return"_undecided.png";
case 1:return"_woot.png"}}function z(b,c,d){var e=API.getDJs()[0],f=!1;"undefined"!==e&&(f=e.username==d);"void"!==b&&(e="http://www.theedmbasement.com/basebot/userlist/"+b,a("#plugbot-userlist").append('<img src="'+e+'" align="left" style="margin-left:6px;margin-top:2px" />'));a("#plugbot-userlist").append('<p class="plugbot-userlist-user" style="cursor:pointer;'+("void"===b?"":"text-indent:6px !important;")+"color:"+c+";"+(f?"font-size:15px;font-weight:bold;":"")+'" >'+d+"</p>")}function P(){var b=
new Date;b.setFullYear(b.getFullYear()+1);jaaulde.utils.cookies.setOptions({expiresAt:b});b=jaaulde.utils.cookies.get(J);n=null!=b?b:!0;b=jaaulde.utils.cookies.get(L);q=null!=b?b:!1;b=jaaulde.utils.cookies.get(K);k=null!=b?b:!1;b=jaaulde.utils.cookies.get(I);l=null!=b?b:!0;n?a("#button-vote-positive").click():p&&a("#button-vote-negative").click();q&&!t()&&u();k&&(a("#yt-frame").animate({height:k?"0px":"271px"},{duration:"fast"}),a("#playback .frame-background").animate({opacity:k?"0":"0.91"},{duration:"medium"}));
l&&s();U(V);injectStyles(".unselectable { -moz-user-select: -moz-none; -khtml-user-select: none; -webkit-user-select: none; -o-user-select: none; user-select: none; }");M(!0);W();f();g();e();var b=a(".chat-input"),d=a("#chat-input-field");a("#dialog-box");var h=a("<span/>",{"class":"emoji emoji-1f603"}).css({margin:"3px 0 0 3px"}),m=a("<div/>",{id:"emoji-button",title:"Insert Emoticons"}).css({position:"absolute",width:"22",height:"24",right:"0",cursor:"pointer"});a("#emoji-button").remove();a("#dialog-emoticons").remove();
d.css("width","267px");h.appendTo(m);m.appendTo(b);c.initHandlers1()}function V(){F=0;setTimeout(function(){h(null)},1E3)}function U(a){var b="",c,d;d=function(){0!==API.getUsers().length&&(a(),clearInterval(c))};setInterval(function(){window.location.href!=b&&(""!==b&&(c=setInterval(d,100)),b=window.location.href)},100)}function M(a){var b=A.get("media");if("undefined"!==typeof b){var c=b.get("format"),b=b.get("cid");"1"===c?C="http://www.youtube.com/watch?v="+b:"2"===c&&(C="http://www.soundcloud.com/");
a||g()}}function W(){window.alert=function(a){console.log("ALERT: "+a)}}function R(){function a(c){var d=!0;c=c||window.event;(d="focus"==c.type||"focusin"==c.type?!0:"blur"==c.type||"focusout"==c.type?!1:!this[b])?(E=!0,s()):E=!1}var b="hidden";b in document?document.addEventListener("visibilitychange",a):(b="mozHidden")in document?document.addEventListener("mozvisibilitychange",a):(b="webkitHidden")in document?document.addEventListener("webkitvisibilitychange",a):(b="msHidden")in document?document.addEventListener("msvisibilitychange",
a):"onfocusin"in document?document.onfocusin=document.onfocusout=a:window.onfocus=window.onblur=a}var n,p=!1,q,k,l,N,F=0,O=3E3,m=!1,D=50,w=!1,C="",E=!0,J="autowoot",L="autoqueue",K="hidevideo",I="userlist",S=50;a("#plugbot-userlist").remove();a("#plugbot-css").remove();a("#plugbot-js").remove();var X=document.getElementsByTagName("head")[0],y=document.createElement("script");y.type="text/javascript";y.src="http://cookies.googlecode.com/svn/trunk/jaaulde.cookies.js";y.onreadystatechange=function(){"complete"==
this.readyState&&P()};y.onload=P;X.appendChild(y);a("body").prepend('<style type="text/css" id="plugbot-css">#plugbot-ui { position: absolute; margin-left: 349px; }#plugbot-ui p { background-color: #0b0b0b; height: 32px; padding-top: 8px; padding-left: 8px; padding-right: 6px; cursor: pointer; font-variant: small-caps; width: 84px; font-size: 15px; margin: 0; }#plugbot-ui h2 { background-color: #0b0b0b; height: 112px; width: 156px; margin: 0; color: #fff; font-size: 13px; font-variant: small-caps; padding: 8px 0 0 12px; border-top: 1px dotted #292929; }#plugbot-userlist { border: 6px solid rgba(10, 10, 10, 0.8); border-left: 0 !important; background-color: #000000; padding: 8px 0px 20px 0px; width: 12%; }#plugbot-userlist p { margin: 0; padding-top: 4px; text-indent: 24px; font-size: 10px; }#plugbot-userlist p:first-child { padding-top: 0px !important; }#plugbot-queuespot { color: #42A5DC; text-align: left; font-size: 15px; margin-left: 8px }');
