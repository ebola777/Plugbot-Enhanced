...
define("app/models/3rd/PlugBot","jquery app/base/Context app/models/PlaybackModel app/views/room/PlaybackView app/models/RoomModel app/views/room/meta/AvatarRolloverView app/models/3rd/EmojiUI".split(" "),function(a,x,B,C,b,d,c){function f(){API.on(API.DJ_ADVANCE,h);API.on(API.WAIT_LIST_UPDATE,v);API.on(API.DJ_UPDATE,v);API.on(API.VOTE_UPDATE,function(a){l&&p()});API.on(API.USER_JOIN,function(a){l&&p()});API.on(API.USER_LEAVE,function(a){l&&p()});API.on(API.CHAT,c.onChatReceived,c);x.on("chat:send",
c.onChatReceived,c)}function g(){a("#plugbot-ui").remove();a("#chat").prepend('<div id="plugbot-ui" class="unselectable"></div>');var b=n?"#3FFF00":"#ED1C24",d=q?"#3FFF00":"#ED1C24",c=s?"#3FFF00":"#ED1C24",f=k?"#3FFF00":"#ED1C24",e=l?"#3FFF00":"#ED1C24";a("#plugbot-ui").append('<p id="plugbot-btn-woot" style="color:'+b+'">auto-woot</p><p id="plugbot-btn-meh" style="color:'+d+'">auto-meh</p><p id="plugbot-btn-queue" style="color:'+c+'">auto-queue</p><p id="plugbot-btn-hidevideo" style="color:'+f+'">hide video</p><p id="plugbot-btn-skipvideo" style="color:#ED1C24">skip video</p><p id="plugbot-btn-userlist" style="color:'+
...
!m;a(this).css("color",m?"#3FFF00":"#ED1C24");a(this).text(m?"skipping video":"skip video");var b=API.getVolume();m?(E=b,API.setVolume(0)):API.setVolume(E);m?(w||k||a("#plugbot-btn-hidevideo").click(),w=!0):(w&&k&&a("#plugbot-btn-hidevideo").click(),w=!1)});a("#plugbot-btn-queue").live("click",function(){s=!s;a(this).css("color",s?"#3FFF00":"#ED1C24");s&&!t()&&u();jaaulde.utils.cookies.set(L,s)});a(".plugbot-userlist-user").live("click",function(){var c=a(this).position(),Q=a(this).text(),f=null;
a.each(b.get("users"),function(a,b){if(b.get("username")===Q)return f=b,!1});d.showChat(f,{x:c.left+300,y:c.top})});R()}function h(b){k&&!m&&(a("#yt-frame").css("height","0px"),a("#playback .frame-background").css("opacity",".0"));m&&(a("#plugbot-btn-skipvideo").css("color","#ED1C24").text("skip video"),w&&k&&a("#plugbot-btn-hidevideo").click(),API.setVolume(E),C.onRefreshClick(),w=m=!1);n?a("#button-vote-positive").click():q&&a("#button-vote-negative").click();l&&p();M(!1)}function v(){s&&!t()&&
u();z=0;p()}function t(){return-1!==API.getBoothPosition()||-1!==API.getWaitListPosition()}function u(){"block"===a("#button-dj-play").css("display")?a("#button-dj-play").click():API.getWaitList().length<S&&API.djJoin()}function p(){if(F){var b=new Date,c=b.getTime(),b=null;clearTimeout(N);if(c-z>=O){z=c;b=a("#plugbot-userlist");c=API.getUsers();b.html(" ").append('<h1 style="text-indent:12px;color:#42A5DC;font-size:14px;font-variant:small-caps;">Users: '+c.length+"</h1>").append('<p style="padding-left:12px;text-indent:0px !important;font-style:italic;color:#42A5DC;font-size:11px;">Click a username to<br />open user-box!</p><br />');
...
new Date;b.setFullYear(b.getFullYear()+1);jaaulde.utils.cookies.setOptions({expiresAt:b});b=jaaulde.utils.cookies.get(J);n=null!=b?b:!0;b=jaaulde.utils.cookies.get(L);s=null!=b?b:!1;b=jaaulde.utils.cookies.get(K);k=null!=b?b:!1;b=jaaulde.utils.cookies.get(I);l=null!=b?b:!0;n?a("#button-vote-positive").click():q&&a("#button-vote-negative").click();s&&!t()&&u();k&&(a("#yt-frame").animate({height:k?"0px":"271px"},{duration:"fast"}),a("#playback .frame-background").animate({opacity:k?"0":"0.91"},{duration:"medium"}));
l&&p();U(V);injectStyles(".unselectable { -moz-user-select: -moz-none; -khtml-user-select: none; -webkit-user-select: none; -o-user-select: none; user-select: none; }");M(!0);W();f();g();e();var b=a(".chat-input"),d=a("#chat-input-field");a("#dialog-box");var h=a("<span/>",{"class":"emoji emoji-1f603"}).css({margin:"3px 0 0 3px"}),m=a("<div/>",{id:"emoji-button",title:"Insert Emoticons"}).css({position:"absolute",width:"22",height:"24",right:"0",cursor:"pointer"});a("#emoji-button").remove();a("#dialog-emoticons").remove();
d.css("width","267px");h.appendTo(m);m.appendTo(b);c.initHandlers1()}function V(){z=0;setTimeout(function(){h(null)},1E3)}function U(a){var b="",c,d;d=function(){0!==API.getUsers().length&&(a(),clearInterval(c))};setInterval(function(){window.location.href!=b&&(""!==b&&(c=setInterval(d,100)),b=window.location.href)},100)}function M(a){var b=B.get("media");if("undefined"!==typeof b){var c=b.get("format"),b=b.get("cid");"1"===c?D="http://www.youtube.com/watch?v="+b:"2"===c&&(D="http://www.soundcloud.com/");
a||g()}}function W(){window.alert=function(a){console.log("ALERT: "+a)}}function R(){function a(c){var d=!0;c=c||window.event;(d="focus"==c.type||"focusin"==c.type?!0:"blur"==c.type||"focusout"==c.type?!1:!this[b])?(F=!0,p()):F=!1}var b="hidden";b in document?document.addEventListener("visibilitychange",a):(b="mozHidden")in document?document.addEventListener("mozvisibilitychange",a):(b="webkitHidden")in document?document.addEventListener("webkitvisibilitychange",a):(b="msHidden")in document?document.addEventListener("msvisibilitychange",
a):"onfocusin"in document?document.onfocusin=document.onfocusout=a:window.onfocus=window.onblur=a}var n,q=!1,s,k,l,N,z=0,O=3E3,m=!1,E=50,w=!1,D="",F=!0,J="autowoot",L="autoqueue",K="hidevideo",I="userlist",S=50;a("#plugbot-userlist").remove();a("#plugbot-css").remove();a("#plugbot-js").remove();var X=document.getElementsByTagName("head")[0],y=document.createElement("script");y.type="text/javascript";y.src="http://cookies.googlecode.com/svn/trunk/jaaulde.cookies.js";y.onreadystatechange=function(){"complete"==
