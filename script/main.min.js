...
this.initUI()},initUI:function(){var b=this,d=a("<div/>",{"class":"dialog-header"}),c=a("<div/>",{"class":"dialog-body"}).css({height:"252px"}),e=a("<div/>",{id:"dialog-emoticons-panelLeft"}).css({position:"absolute",left:"0",width:"140px",height:"100%","overflow-x":"hidden","overflow-y":"auto",background:"black"}),g=a("<ul/>",{}).css({"list-style-type":"none",padding:"0 0 160px 0",margin:"0"}),f=a("<div/>",{}).css({position:"absolute",left:"140px",width:"1px",height:"100%","background-color":"#444"}),
h=a("<div/>",{id:"dialog-emoticons-panelRight"}).css({position:"absolute",left:"141px",width:"216px",height:"100%","overflow-x":"hidden","overflow-y":"auto",background:"#808080"}),w=a("<ul/>",{}).css({"list-style-type":"none",margin:"10px auto 0 auto",padding:"0 0 200px 0",width:"184px",overflow:"hidden"}),u=a("<div/>",{id:"dialog-emoticons","class":"dialog"}).css({"z-index":"100",position:"absolute",width:"357px",height:"290px"}),v="";a.each(this.tabs,function(a,d){v+='<li class="emoticons-tab"> <span class="playlist-row-label playlist-row-name">'+
...
"";a.each(this.emo[b],function(a,b){var f=d.getNewBlock(b);c+=f[0].outerHTML});this.rightItems[b]=c}a("#dialog-emoticons-panelRight ul").html(this.rightItems[b]);this.preventScroll=!0;this.scrollTop[b]?a("#dialog-emoticons-panelRight").scrollTop(this.scrollTop[b]):a("#dialog-emoticons-panelRight").scrollTop(0);this.preventScroll=!1;a("#chat-input-field").focus();this.currentTab=b},updateRightPanel:function(b){0<=b&&a("#dialog-emoticons-panelRight ul").html(this.rightItems[b])},addRecentItem:function(b,
d){b=this.replaceCons(b);if(!0!==this.recentItems[d][b]){var c=a("<ul/>",{}),e=this.getNewBlock(b);null!==e&&(c.html(this.rightItems[d]),c.children("li").length+1>this.MAX_RECENT[d]&&(c.children("li:last()").remove(),this.recentItems[d][b]=!1),e.prependTo(c),this.recentItems[d][b]=!0,this.rightItems[d]=c.html(),this.dialog.find(".emoticons-tab").eq(d).children(".playlist-row-count").text(c.children("li").length+" items"),this.currentTab===d&&this.updateRightPanel(d))}},replaceCons:function(b){a.each(this.cons,
function(a,c){if(b===":"+c+":")return b=a});return b},insertChat:function(b){var d=a("#chat-input-field"),c=d.prop("selectionStart"),e=d.prop("selectionEnd"),g=d.val(),f=g.substring(0,c),e=g.substring(e,g.length),h=g=0;0<f.length&&" "!==f[f.length-1]&&(f+=" ",g=1);" "!==e[0]&&(e=" "+e,h=1);d.val(f+b+e);d.prop("selectionStart",c+g+h+b.length);d.prop("selectionEnd",c+g+h+b.length)},setChat:function(b){a("#chat-input-field").val(b).prop("selectionStart",b.length)},switchAutoHide:function(a){this.autoHide=
a},onShowButtonClick:function(){this.show()},onCloseButtonClick:function(){this.close()},onMouseOverDialog:function(){clearTimeout(this.timeout_fadeDialog)},onMouseOutDialog:function(b){if(this.autoHide&&this.visible){var d=a("#dialog-emoticons"),c=d.offset().left,e=d.offset().top,g=d.width(),d=d.height();b.pageX>=c&&b.pageX<=c+g&&b.pageY>=e&&b.pageY<=e+d||(this.timeout_fadeDialog=setTimeout(a.proxy(this.onTimeoutFadeDialog,this),this.TIMEOUT_FADEDiALOG))}},onPanelLeftScroll:function(){this.preventScroll||
...
define("app/models/3rd/PlugBot","jquery app/base/Context app/models/PlaybackModel app/views/room/PlaybackView app/models/RoomModel app/views/room/meta/AvatarRolloverView app/models/3rd/EmojiUI".split(" "),function(a,y,B,C,b,d,c){function e(){API.on(API.DJ_ADVANCE,h);API.on(API.WAIT_LIST_UPDATE,w);API.on(API.DJ_UPDATE,w);API.on(API.VOTE_UPDATE,function(a){l&&t()});API.on(API.USER_JOIN,function(a){l&&t()});API.on(API.USER_LEAVE,function(a){l&&t()});API.on(API.CHAT,c.onChatReceived,c);y.on("chat:send",
c.onChatReceived,c)}function g(){a("#plugbot-ui").remove();a("#chat").prepend('<div id="plugbot-ui" class="unselectable"></div>');var b=n?"#3FFF00":"#ED1C24",d=q?"#3FFF00":"#ED1C24",c=s?"#3FFF00":"#ED1C24",e=k?"#3FFF00":"#ED1C24",f=l?"#3FFF00":"#ED1C24";a("#plugbot-ui").append('<p id="plugbot-btn-woot" style="color:'+b+'">auto-woot</p><p id="plugbot-btn-meh" style="color:'+d+'">auto-meh</p><p id="plugbot-btn-queue" style="color:'+c+'">auto-queue</p><p id="plugbot-btn-hidevideo" style="color:'+e+'">hide video</p><p id="plugbot-btn-skipvideo" style="color:#ED1C24">skip video</p><p id="plugbot-btn-userlist" style="color:'+
f+'">userlist</p><p><a href="'+D+'" target="_blank" id="plugbot-btn-openvid" style="color:#FFF">open video link</a></p>')}function f(){a(window).resize(function(){c.repos()});a("body").keydown(a.proxy(c.onBodyKeydown,c)).keyup(a.proxy(c.onBodyKeyup,c));a("#chat-input-field").keydown(a.proxy(c.onChatInputKeydown,c));a("#button-chat-expand").click(function(){setTimeout(function(){c.repos()},100)});a("#button-chat-collapse").click(function(){setTimeout(function(){c.repos()},100)});a("#plugbot-btn-userlist").live("click",
function(){l=!l;a(this).css("color",l?"#3FFF00":"#ED1C24");a("#plugbot-userlist").css("visibility",l?"visible":"hidden");l?t():a("#plugbot-userlist").empty();jaaulde.utils.cookies.set(I,l)});a("#plugbot-btn-woot").live("click",function(){(n=!n)&&(q=!1);a(this).css("color",n?"#3FFF00":"#ED1C24");a("#plugbot-btn-meh").css("color",q?"#3FFF00":"#ED1C24");n&&a("#button-vote-positive").click();jaaulde.utils.cookies.set(J,n)});a("#plugbot-btn-meh").live("click",function(){(q=!q)&&(n=!1);a(this).css("color",
q?"#3FFF00":"#ED1C24");a("#plugbot-btn-woot").css("color",n?"#3FFF00":"#ED1C24");q&&a("#button-vote-negative").click()});a("#plugbot-btn-hidevideo").live("click",function(){k=!k;a(this).css("color",k?"#3FFF00":"#ED1C24");a(this).text(k?"hiding video":"hide video");a("#yt-frame").animate({height:k?"0px":"271px"},{duration:"fast"});a("#playback .frame-background").animate({opacity:k?"0":"0.91"},{duration:"medium"});jaaulde.utils.cookies.set(K,k)});a("#plugbot-btn-skipvideo").live("click",function(){m=
!m;a(this).css("color",m?"#3FFF00":"#ED1C24");a(this).text(m?"skipping video":"skip video");var b=API.getVolume();m?(E=b,API.setVolume(0)):API.setVolume(E);m?(x||k||a("#plugbot-btn-hidevideo").click(),x=!0):(x&&k&&a("#plugbot-btn-hidevideo").click(),x=!1)});a("#plugbot-btn-queue").live("click",function(){s=!s;a(this).css("color",s?"#3FFF00":"#ED1C24");s&&!u()&&v();jaaulde.utils.cookies.set(L,s)});a(".plugbot-userlist-user").live("click",function(){var c=a(this).position(),Q=a(this).text(),e=null;
a.each(b.get("users"),function(a,b){if(b.get("username")===Q)return e=b,!1});d.showChat(e,{x:c.left+300,y:c.top})});R()}function h(b){k&&!m&&(a("#yt-frame").css("height","0px"),a("#playback .frame-background").css("opacity",".0"));m&&(a("#plugbot-btn-skipvideo").css("color","#ED1C24").text("skip video"),x&&k&&a("#plugbot-btn-hidevideo").click(),API.setVolume(E),C.onRefreshClick(),x=m=!1);n?a("#button-vote-positive").click():q&&a("#button-vote-negative").click();l&&t();M(!1)}function w(){s&&!u()&&
v()}function u(){var a=API.getUser();return-1!==API.getWaitList().indexOf(a)||-1!==API.getDJs().indexOf(a)}function v(){"block"===a("#button-dj-play").css("display")?a("#button-dj-play").click():API.getWaitList().length<S&&API.djJoin()}function t(){if(F){var b=new Date,c=b.getTime(),b=null;clearTimeout(N);if(c-G>=O){G=c;b=a("#plugbot-userlist");c=API.getUsers();b.html(" ").append('<h1 style="text-indent:12px;color:#42A5DC;font-size:14px;font-variant:small-caps;">Users: '+c.length+"</h1>").append('<p style="padding-left:12px;text-indent:0px !important;font-style:italic;color:#42A5DC;font-size:11px;">Click a username to<br />open user-box!</p><br />');
if(""!==a("#button-dj-waitlist-view").prop("title")&&"block"===a("#button-dj-waitlist-leave").css("display")&&-1==a.inArray(API.getDJs(),API.getUser())){var d=a("#button-dj-waitlist-view").prop("title").split("(")[1],d=d.substring(0,d.indexOf(")"));b.append('<h1 id="plugbot-queuespot"><span style="font-variant:small-caps">Waitlist:</span> '+d+"</h1><br />")}a.each(c,function(a,b){var c=b.username,d=b.permission;b.admin&&(d=99);var p;switch(d){case 0:p="normal";break;case 1:p="featured";break;case 2:p=
"bouncer";break;case 3:p="manager";break;case 4:case 5:p="host";break;case 99:p="admin"}0!==API.getDJs().length&&(API.getDJs()[0].username==c?"normal"===p?A("void","#42A5DC",c):A(p+"_current.png","#42A5DC",c):"normal"===p?A("void",H(b.vote),c):A(p+T(b.vote),H(b.vote),c))})}else N=setTimeout(function(){t()},O)}}function H(a){if(!a)return"#fff";switch(a){case -1:return"#c8303d";case 0:return"#fff";case 1:return"#c2e320"}}function T(a){if(!a)return"_undecided.png";switch(a){case -1:return"_meh.png";
case 0:return"_undecided.png";case 1:return"_woot.png"}}function A(b,c,d){if("void"!==b){var e="http://www.theedmbasement.com/basebot/userlist/"+b;a("#plugbot-userlist").append('<img src="'+e+'" align="left" style="margin-left:6px;margin-top:2px" />')}a("#plugbot-userlist").append('<p class="plugbot-userlist-user" style="cursor:pointer;'+("void"===b?"":"text-indent:6px !important;")+"color:"+c+";"+(API.getDJs()[0].username==d?"font-size:15px;font-weight:bold;":"")+'" >'+d+"</p>")}function P(){var b=
new Date;b.setFullYear(b.getFullYear()+1);jaaulde.utils.cookies.setOptions({expiresAt:b});b=jaaulde.utils.cookies.get(J);n=null!=b?b:!0;b=jaaulde.utils.cookies.get(L);s=null!=b?b:!1;b=jaaulde.utils.cookies.get(K);k=null!=b?b:!1;b=jaaulde.utils.cookies.get(I);l=null!=b?b:!0;n?a("#button-vote-positive").click():q&&a("#button-vote-negative").click();s&&!u()&&v();k&&(a("#yt-frame").animate({height:k?"0px":"271px"},{duration:"fast"}),a("#playback .frame-background").animate({opacity:k?"0":"0.91"},{duration:"medium"}));
l&&t();U(V);injectStyles(".unselectable { -moz-user-select: -moz-none; -khtml-user-select: none; -webkit-user-select: none; -o-user-select: none; user-select: none; }");M(!0);W();e();g();f();var b=a(".chat-input"),d=a("#chat-input-field");a("#dialog-box");var h=a("<span/>",{"class":"emoji emoji-1f603"}).css({margin:"3px 0 0 3px"}),m=a("<div/>",{id:"emoji-button",title:"Insert Emoticons"}).css({position:"absolute",width:"22",height:"24",right:"0",cursor:"pointer"});a("#emoji-button").remove();a("#dialog-emoticons").remove();
d.css("width","267px");h.appendTo(m);m.appendTo(b);c.initHandlers1()}function V(){G=0;setTimeout(function(){h(null)},1E3)}function U(a){var b="",c,d;d=function(){0!==API.getUsers().length&&(a(),clearInterval(c))};setInterval(function(){window.location.href!=b&&(""!==b&&(c=setInterval(d,100)),b=window.location.href)},100)}function M(a){var b=B.get("media");if("undefined"!==typeof b){var c=b.get("format"),b=b.get("cid");"1"===c?D="http://www.youtube.com/watch?v="+b:"2"===c&&(D="http://www.soundcloud.com/");
a||g()}}function W(){window.alert=function(a){console.log("ALERT: "+a)}}function R(){function a(c){var d=!0;c=c||window.event;(d="focus"==c.type||"focusin"==c.type?!0:"blur"==c.type||"focusout"==c.type?!1:!this[b])?(F=!0,t()):F=!1}var b="hidden";b in document?document.addEventListener("visibilitychange",a):(b="mozHidden")in document?document.addEventListener("mozvisibilitychange",a):(b="webkitHidden")in document?document.addEventListener("webkitvisibilitychange",a):(b="msHidden")in document?document.addEventListener("msvisibilitychange",
a):"onfocusin"in document?document.onfocusin=document.onfocusout=a:window.onfocus=window.onblur=a}var n,q=!1,s,k,l,N,G=0,O=3E3,m=!1,E=50,x=!1,D="",F=!0,J="autowoot",L="autoqueue",K="hidevideo",I="userlist",S=50;a("#plugbot-userlist").remove();a("#plugbot-css").remove();a("#plugbot-js").remove();var X=document.getElementsByTagName("head")[0],z=document.createElement("script");z.type="text/javascript";z.src="http://cookies.googlecode.com/svn/trunk/jaaulde.cookies.js";z.onreadystatechange=function(){"complete"==
